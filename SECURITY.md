...
Security vulnerabilities should be [disclosed](#reporting-a-vulnerability) to the [project maintainers](./.github/CODEOWNERS).
...
Please use the following link to submit your vulnerability: [Report a vulnerability](https://github.com/abbyssoul/orishu/security/advisories/new)
...
Orishu is made available under the Apache License, which disclaims all warranties in relation to the project and which limits the liability of those that contribute and maintain the project. You are solely responsible for any use of orishu and you assume all risks associated with any such use. This Security Policy in no way evidences or represents an on-going duty by any contributor, to correct any flaws or alert you to all or any of the potential risks of utilizing the project.
