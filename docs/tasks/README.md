...
| [Implement the physical Raspberry Pi formation experiment](implement-physical-formation-experiment.md) | Planned for 3/5 dedicated Pis; private per-node preparation and strict SSH readiness collection implemented; remote load/synchronization/control/results driver and hardware validation remain |
