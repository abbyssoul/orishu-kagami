...
- [0025 — Version peer trace-context propagation separately from membership semantics](0025-version-peer-trace-context-propagation.md) (**accepted; implementation pending**)
