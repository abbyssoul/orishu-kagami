...
- [0010 — Use content-addressed workload closures and portable bundles](0010-content-addressed-workload-closure-and-portable-bundles.md)
  (includes the first stored-ZIP encoding refinement and layout comparison)
...
- [0028 — Fence worker scientific admission through the formation owner](0028-fence-worker-scientific-admission-through-formation-owner.md) (**reservation, admission and retained single-node execution/publication implemented; allocation refined by ADR 0029 and opt-in load serving by ADR 0031**)
