...
- declarative authoring schemas describing the models, fields, parameters,
  dimensions, constraints, initial conditions, and observations Kagami can
  offer;
- one pinned WebAssembly workload component implementing Orishu's versioned,
  capability-limited workload lifecycle;
...
IDE / build and test tools
        ...
        v
simulation plugin
  manifest + authoring schemas + pinned workload component
        |
